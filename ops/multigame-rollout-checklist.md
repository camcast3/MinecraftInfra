...
Use
[`Invoke-MultigameRolloutValidation.ps1`](../tools/validation/Invoke-MultigameRolloutValidation.ps1)
...
```powershell
pwsh ./tools/validation/Invoke-MultigameRolloutValidation.ps1

# Optional authenticated, read-only ARM comparison. This never deploys.
pwsh ./tools/validation/Invoke-MultigameRolloutValidation.ps1 -AzureWhatIf
```
