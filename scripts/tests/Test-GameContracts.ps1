...
$validatorPath = Join-Path $repositoryRoot 'scripts/Validate-GameContracts.ps1'
$sourceContracts = Join-Path $repositoryRoot 'contracts'
...
try {
    ...
    $composePath = Join-Path $fixtureRepository 'docker/azure/docker-compose.yml'
